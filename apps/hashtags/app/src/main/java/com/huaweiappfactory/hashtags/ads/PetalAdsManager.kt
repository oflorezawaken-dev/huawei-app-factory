package com.huaweiappfactory.hashtags.ads
...
/**
 * Where a banner may appear. Never on the set screen: choosing tags is the whole
 * product, and an ad beside a grid of chips is an ad people tap by accident.
 */
enum class AdPlacement { TOPICS_BANNER, SETTINGS_BANNER }

/** Natural pauses where an interstitial may be considered. */
enum class InterstitialTrigger { TAGS_COPIED }
 ...
 * Every failure is swallowed and logged: ads must never get between someone and
 * the tags they came for.
 */
