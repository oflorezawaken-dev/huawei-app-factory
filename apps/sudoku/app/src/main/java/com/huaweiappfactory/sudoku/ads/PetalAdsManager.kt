package com.huaweiappfactory.sudoku.ads
...
/**
 * Where a banner may appear. Never on the board: the grid is the whole product and
 * the specification keeps every ad off it.
 */
enum class AdPlacement { HOME_BANNER, STATS_BANNER }

/** Natural pauses where an interstitial may be considered. */
enum class InterstitialTrigger { PUZZLE_FINISHED }
 ...
 * Every failure is swallowed and logged: ads must never interrupt a puzzle.
 */
