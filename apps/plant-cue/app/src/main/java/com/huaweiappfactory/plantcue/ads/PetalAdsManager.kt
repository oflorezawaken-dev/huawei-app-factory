package com.huaweiappfactory.plantcue.ads
...
import com.huaweiappfactory.plantcue.BuildConfig

/**
 * Where a banner may appear. Never on Today, Add/Edit or Plant Detail: those are
 * the care and data-entry surfaces the spec protects from ads.
 */
enum class AdPlacement { PLANTS_BANNER, STATS_BANNER }
